...
class TRMAttendeeTotal extends PolymerElement {
	static get template() {
		return html`
			<style>
				:host {
			...
			<div class="total-title">Donation Total</div>
			<div class="total-container">$<span id="total"></span></div>
		`;
	}

	static get is() {
		return "trm-attendee-total";
	}
...
customElements.define(TRMAttendeeTotal.is, TRMAttendeeTotal);
