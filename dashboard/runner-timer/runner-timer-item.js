	...
	static get template() {
		return html`
			...
			<div id="body">
				...
				<button type="button" class="btn btn-sm btn-success" id="startTimer" class="start" disabled$="[[shouldDisableIfNotFinished()]]">
					Resume
				</button>

				<button type="button" class="btn btn-sm btn-primary" id="finishTimer" class="finish" disabled$="[[shouldDisableWhenNotRunning()]]">
					Finish
				</button>
